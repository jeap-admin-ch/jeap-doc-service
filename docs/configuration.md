...
| `jeap.doc.build.history-retention`      | `P90D`             | How long the record of a build is kept. **The published build of each part is kept whatever its age** - it is what says which publication a part is served from                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
