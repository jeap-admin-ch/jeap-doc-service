 ...
 */
@Entity
@Table(name = "architecture_rest_api")
@IdClass(ArchitectureRestApiEntity.Key.class)
@Getter
@Setter
@NoArgsConstructor(access = AccessLevel.PROTECTED) // for jpa
class ArchitectureRestApiEntity implements Persistable<ArchitectureRestApiEntity.Key> {
    ...
    public Key getId() {
        Key key = new Key();
        key.setComponentId(componentId);
