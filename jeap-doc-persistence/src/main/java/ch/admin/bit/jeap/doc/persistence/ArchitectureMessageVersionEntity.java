...
/**
 * One version of a message that exists.
 */
@Entity
@Table(name = "architecture_message_version")
@IdClass(ArchitectureMessageVersionEntity.Key.class)
@Getter
@Setter
@NoArgsConstructor(access = AccessLevel.PROTECTED) // for jpa
class ArchitectureMessageVersionEntity implements Persistable<ArchitectureMessageVersionEntity.Key> {
